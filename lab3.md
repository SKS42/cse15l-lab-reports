...
```
The -name command finds all the files with .txt in it's name in the written_2 dirrectory. This command is usefull because you don't need to use the grep command to find files with txt it it's name.
```
sebastiansmith@Sebastians-MacBook-Pro-3 docsearch % find written_2 -name berlitz2
written_2/travel_guides/berlitz2
```
The -name "berlitz2" command finds all the files that end with berlitz2. This command is usefull if you just want to find files that end with berlitz2.
